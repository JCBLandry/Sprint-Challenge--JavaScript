...
console.log(`${rex.weight}kg`);

// What was the diet of a velociraptor?
console.log(velo.diet);

// How long was a stegosaurus?
console.log(`${stego.length}m`);

// What time period did tyrannosaurus live in?
console.log(rex.peroid);
...
let lowerCase = [];
lowerCase = zooAnimals.map(caps => caps.animal_name.toLowerCase());
...
populationTotal = zooAnimals.reduce((accumulator, value) =>
  accumulator + value.population, 0);
